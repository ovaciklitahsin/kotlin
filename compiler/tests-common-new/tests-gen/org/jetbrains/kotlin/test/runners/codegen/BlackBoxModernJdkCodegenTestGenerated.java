...
public class BlackBoxModernJdkCodegenTestGenerated extends AbstractBlackBoxCodegenTest {
    ...
    public class TestsWithJava11 {
        ...
        public class Release {
            ...
            public void testAllFilesPresentInRelease() throws Exception {
                KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxModernJdk/testsWithJava11/release"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM, true);
            }
    ...
    public class TestsWithJava17 {
        ...
        public class Release {
            @Test
            public void testAllFilesPresentInRelease() throws Exception {
                KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/boxModernJdk/testsWithJava17/release"), Pattern.compile("^(.+)\\.kt$"), null, TargetBackend.JVM, true);
            }
