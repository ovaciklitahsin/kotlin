...
class Fe10DescNamedClassOrObjectKtSymbolPointer(private val classId: ClassId) : KtSymbolPointer<KtNamedClassOrObjectSymbol>() {
    ...
    override fun restoreSymbol(analysisSession: KtAnalysisSession): KtNamedClassOrObjectSymbol? {
        ...
        return Fe10DescKtNamedClassOrObjectSymbol(descriptor, analysisContext)
    }
}