...
internal class Fe10PsiKtNamedClassOrObjectSymbol(
    override val psi: KtClassOrObject,
    override val analysisContext: Fe10AnalysisContext
) : KtNamedClassOrObjectSymbol(), Fe10PsiKtSymbol<KtClassOrObject, ClassDescriptor> {
    ...
    override val companionObject: KtNamedClassOrObjectSymbol?
        get() = withValidityAssertion {
            ...
            Fe10PsiKtNamedClassOrObjectSymbol(companionObject, analysisContext)
        }
