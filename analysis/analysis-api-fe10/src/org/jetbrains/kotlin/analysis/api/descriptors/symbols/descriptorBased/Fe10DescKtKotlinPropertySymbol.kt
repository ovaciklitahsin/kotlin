...
internal class Fe10DescKtKotlinPropertySymbol(
    override val descriptor: PropertyDescriptorImpl,
    override val analysisContext: Fe10AnalysisContext
) : KtKotlinPropertySymbol(), Fe10DescMemberKtSymbol<PropertyDescriptorImpl> {
    ...
    override val setter: KtPropertySetterSymbol?
        get() = withValidityAssertion {
            ...
            return Fe10DescKtPropertySetterSymbol(setter, analysisContext)
        }
