...
internal class Fe10PsiKtPropertySetterSymbol(
    override val psi: KtPropertyAccessor,
    override val analysisContext: Fe10AnalysisContext
) : KtPropertySetterSymbol(), Fe10PsiKtSymbol<KtPropertyAccessor, PropertySetterDescriptor> {
    ...
    override val parameter: KtValueParameterSymbol
        get() = withValidityAssertion {
            ...
            return if (parameter != null) {
                Fe10PsiKtValueParameterSymbol(parameter, analysisContext)
            } else {
                Fe10PsiDefaultKtSetterParameterSymbol(psi, analysisContext)
            }
        }
