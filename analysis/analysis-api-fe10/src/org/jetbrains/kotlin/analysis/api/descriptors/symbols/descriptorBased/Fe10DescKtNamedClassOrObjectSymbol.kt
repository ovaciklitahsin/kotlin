...
import org.jetbrains.kotlin.analysis.api.descriptors.symbols.pointers.Fe10DescNamedClassOrObjectKtSymbolPointer
...
internal class Fe10DescKtNamedClassOrObjectSymbol(
    override val descriptor: ClassDescriptor,
    override val analysisContext: Fe10AnalysisContext
) : KtNamedClassOrObjectSymbol(), Fe10DescMemberKtSymbol<ClassDescriptor> {
    ...
    override val companionObject: KtNamedClassOrObjectSymbol?
        get() {
            withValidityAssertion {
                ...
                return Fe10DescKtNamedClassOrObjectSymbol(companionObject, analysisContext)
            }
        }
    ...
    override fun createPointer(): KtSymbolPointer<KtNamedClassOrObjectSymbol> = withValidityAssertion {
        ...
        if (classId != null) {
            return Fe10DescNamedClassOrObjectKtSymbolPointer(classId)
        }
