...
import org.jetbrains.kotlin.analysis.api.descriptors.symbols.pointers.Fe10DescSamConstructorKtSymbolPointer
...
internal class Fe10DescKtSamConstructorSymbol(
    ...
    override fun createPointer(): KtSymbolPointer<KtSamConstructorSymbol> = withValidityAssertion {
        ...
        if (classId != null) {
            return Fe10DescSamConstructorKtSymbolPointer(classId)
        }
