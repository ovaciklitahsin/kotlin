...
internal class Fe10JvmTypeMapperContext(private val resolveSession: ResolveSession) : TypeMappingContext<JvmSignatureWriter> {
    companion object {
    ...
    override val typeContext = Fe10TypeSystemCommonBackendContextForTypeMapping(resolveSession)
